...
#define S_FUNCTION_NAME                buck_control
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                display
...
#define SOURCEFILES                    "__SFB__buck.c__SFB__controller.c"
...
extern void buck_control_Outputs_wrapper(const real_T *target,
  const real_T *Uc_in,
  const real_T *IL_in,
  const real_T *time,
  real_T *display,
...
{
  const real_T *target = (real_T *) ssGetInputPortRealSignal(S, 0);
  const real_T *Uc_in = (real_T *) ssGetInputPortRealSignal(S, 1);
  const real_T *IL_in = (real_T *) ssGetInputPortRealSignal(S, 2);
  const real_T *time = (real_T *) ssGetInputPortRealSignal(S, 3);
  real_T *display = (real_T *) ssGetOutputPortRealSignal(S, 0);
  real_T *pwmref = (real_T *) ssGetOutputPortRealSignal(S, 1);
  buck_control_Outputs_wrapper(target, Uc_in, IL_in, time, display, pwmref);
}
